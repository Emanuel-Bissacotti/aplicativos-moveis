        ...
        buttonBuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cep.length() == 8) {
                    ...
                    Toast.makeText(ActivityEndereco.this, "CEP inválido", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        call.enqueue(new Callback<Endereco>() {
            ...
            public void onResponse(Call<Endereco> call, Response<Endereco> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(ActivityEndereco.this, "Erro ao buscar endereço", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<Endereco> call, Throwable t) {
                Toast.makeText(ActivityEndereco.this, "Erro na requisição", Toast.LENGTH_SHORT).show();
